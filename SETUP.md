...
Однако, лучше проверить самостоятельно, что у вас есть две БД, одна coution и вторая test (к примеру), плюс проверить есть
ли в них нужные столбцы, согласно Models.py
